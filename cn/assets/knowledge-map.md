...
> 本文件由 `文章-能力-资产矩阵.json` 整理生成。JSON/XLSX 是盘点源数据，本页用于阅读、导航和评审。
...
- [x] 已建立文章-能力-资产矩阵（源数据：`文章-能力-资产矩阵.json`，可读视图：本页）。
...
- [Agent trusted execution loop article](../可靠性层/Agent可信执行闭环：从Trace、Evals到可恢复执行.md)
